...
public class register_customer extends AppCompatActivity {
    ...
    private EditText registerFullName, registerEmail, registerContactNo, registerUsername, registerPassword, registerConfPassword;
    ...
    private String fullName, emailAddress, contactNumber, username, password, confirmPassword;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        registerBtnCreateAccount = findViewById(R.id.registerBtnCreateAccount);
        image = findViewById(R.id.registerProfilePicture);
        ...
        registerBtnToLogin = findViewById(R.id.registerBtnToLogin);
        ...
        registerBtnToLogin.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent2login = new Intent(register_customer.this, MainActivity.class);
    ...
    private void createAccount(){
        auth.createUserWithEmailAndPassword(emailAddress, password).addOnSuccessListener(new OnSuccessListener<AuthResult>() {
            ...
            public void onSuccess(AuthResult authResult) {
                saveAccountData();
                registerFullName.getText().clear();
            ...
            public void onFailure(@NonNull Exception e) {
                Toast.makeText(register_customer.this, e.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
        ...
        if (image_uri == null) {
            ...
            dbref.child(auth.getUid()).setValue(hashMap).addOnSuccessListener(new OnSuccessListener<Void>() {
                ...
                public void onSuccess(Void aVoid) {
                    Toast.makeText(register_customer.this, "Register Successfully!", Toast.LENGTH_SHORT).show();
                    if (auth.getCurrentUser().isEmailVerified()) {
                        Intent intent2customer_main = new Intent(register_customer.this, customer_main.class);
                ...
                @Override
                public void onFailure(@NonNull Exception e) {
                    Toast.makeText(register_customer.this, "Register Unsuccessfully!", Toast.LENGTH_SHORT).show();
                }
            });
        }
        //add data w/ image
